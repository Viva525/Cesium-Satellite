...
const UseMapClass: React.FC<UseTimeProps> = (props) => {
  ...
  useEffect(() => {
    if (nowData) {
      ...
      const colorList = ['rgb(0, 212, 255)', 'rgb(79, 112, 225)','rgb(58, 120, 111)', 'rgb(59, 201, 161)', 'rgb(117, 216, 116)']
